<template>
    <div>
        ...
        <invoices-list :invoices="pendingInvoices" :meta="pendingInvoicesMeta" :links="pendingInvoicesLinks" @refreshInvoices="refreshPendingInvoices" @declareAsPaid="loadPendingInvoices"></invoices-list>
